...
- **Moisson OAI-PMH** — synchronisation automatique d'un catalogue Koha, PMB, DSpace ou HAL (ajouts, modifications, suppressions)
- **Numérotation nationale** — identifiant unique de 15 caractères (ex. `SNUCT2016000192` : établissement, type, année, rang) avec clé de contrôle modulo 97, attribué à la soutenance ; code établissement géré depuis l'administration
